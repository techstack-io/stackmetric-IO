    ...
    <div className="w-full">
      <nav className="container relative flex flex-wrap items-center justify-between p-8 mx-auto lg:justify-between xl:px-0">
          ...
          {({ open }) => (
            <>
              <div className="flex flex-wrap items-center justify-between w-full lg:w-auto">
                <Link href="/">
                  <a className="flex items-center space-x-2 text-2xl font-medium text-pureBlue dark:text-gray-100">
                    <span>
                      <img
                        src="/img/stackmetricLogo.svg"
                        alt="N"
                        width="42"
                        height="42"
                        className="w-18"
                ...
                <Disclosure.Panel className="flex flex-wrap w-full my-5 lg:hidden">
                  <>
                    ...
                    <Link href="/">
                      <a className="w-full px-6 py-2 mt-3 text-center text-white bg-pureBlue rounded-md lg:ml-5">
                        Get Started
                      </a>
                    </Link>
                  </>
        ...
        <div className="hidden mr-3 space-x-4 lg:flex nav__item">
          <Link href="/">
            <a className="px-6 py-2 text-white bg-pureBlue rounded-md md:ml-5">
              Get Started
            </a>
          </Link>
