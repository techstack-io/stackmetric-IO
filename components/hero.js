      ...
      <Container className="flex flex-wrap ">
        <div className="flex items-center w-full lg:w-1/2">
          <div className="max-w-2xl mb-8">
            <h1 className="text-4xl font-bold leading-snug tracking-tight text-pureBlue lg:text-4xl lg:leading-tight xl:text-6xl xl:leading-tight dark:text-white">
             App Development and Technical Solutions
            </h1>
            ...
            <div className="flex flex-col items-start space-y-3 sm:space-x-4 sm:space-y-0 sm:items-center sm:flex-row">
              <a
                ...
                target="_blank"
                rel="noopener"
                className="px-8 py-4 text-lg font-medium text-center text-white bg-pureBlue rounded-md ">
                Download for Free
              </a>
              <a
